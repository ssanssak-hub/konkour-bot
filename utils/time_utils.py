...
def get_study_tips():
    """
    تابع برای ارائه نکات مطالعاتی
    """
    study_tips = [
        "📚 مطالعه فعالانه داشته باشید - فقط خواندن کافی نیست",
        "⏰ زمان‌بندی منظم برای مطالعه رعایت کنید",
        "✍️ خلاصه‌نویسی و یادداشت‌برداری کنید",
        "🔄 مرور دوره‌ای مطالب فراموش نشود",
        "🎯 روی نقاط ضعف خود تمرکز کنید",
        "💤 استراحت کافی داشته باشید",
        "🧘‍♂️ سلامت روان و جسم خود را حفظ کنید"
    ]
    return study_tips
